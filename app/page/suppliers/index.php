            ...
            <div class="row mb-2">
                ...
                ?><div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <a href="index.php?page=suppliers&act=create">
                            ...
                            <div class="col-18 col-md-16 mb-md-3 col-lg-12">
                                <form action="" method="post">
                                    <div class="form-grup">
                                        <div class="row">
                                            <div class="col-3">
                                                <input type='text' class="form-control" name="keyword" autocomplete="off" placeholder="Nama Suppliers">
                                            </div>
                                ...
                                <tbody class="text-center">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            ?>
                                                <td>
                                                    <a class="btn btn-primary btn-action mr-1" href="index.php?page=suppliers&act=edit&id=<?= $row["id"] ?>"><i class="fas fa-edit"></i></a>
...
<script>
    document.querySelectorAll('.btn-delete').forEach(button => {
        button.addEventListener('click', function(event) {
            ...
            const idSuppliers = this.getAttribute('data-id');
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `index.php?page=suppliers&act=delete&id=${idSuppliers}`;
                }
            });
        });
    });
